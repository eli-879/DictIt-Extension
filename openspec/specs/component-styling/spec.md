...
Define how component styles are organized so that styling stays co-located with the components that own it, while genuinely shared utilities remain global.
